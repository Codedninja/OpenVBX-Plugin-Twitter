<div class="vbx-applet">
	<div class="vbx-full-pane">
		...
		<fieldset class="vbx-input-container">
			<input type="text" name="name" class="medium" value="<?php echo AppletInstance::getValue('name','codedninja'); ?>" />
		</fieldset>
		
		<h3>Hash tag</h3>
		<p>optional.</p>
		<fieldset class="vbx-input-container">
			<input type="text" name="hash" class="medium" value="<?php echo AppletInstance::getValue('hash', ''); ?>" />
		</fieldset>
	</div>
